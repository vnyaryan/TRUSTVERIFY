...
export function PricingSection() {
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-background to-primary-50/50 premium-section">
              ...
              <CardFooter className="p-6 pt-0">
                <Link href="/register" className="w-full">
                  <Button
                    ...
                    className={plan.popular ? "premium-button w-full" : "w-full border-primary/20 hover:bg-primary-50"}
                  >
                    {plan.cta}
                  </Button>
                </Link>
